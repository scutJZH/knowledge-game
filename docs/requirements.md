...
| REQ-106 | 题库管理对接回收站 | confirmed | [PRD](prd/req-106-question-recycle-bin.md) | DELETE 改为移入回收站；实现 `QuestionRecycleBinStrategy` Bean，`question_deleted.related_data` JSON 快照 | REQ-100 ✅, REQ-103 ✅, REQ-102 ✅, REQ-09 ✅ |
